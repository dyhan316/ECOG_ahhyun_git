...
parser.add_argument('--subject_agg', type = str, default = 'sub_agg', help = 'subject-wise or sub_agg')
...
#save the results
os.makedirs(f'results/ML/{args.subject_agg}', exist_ok=True)
results.to_csv(f"results/ML/{args.subject_agg}/results_seed-{args.seed}.csv", index=False)
